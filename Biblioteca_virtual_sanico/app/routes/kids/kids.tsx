...
const livrosKids = [
  {
    id: 1,
    titulo: "Livro Infantil",
    descricao:
      "Uma história mágica e divertida para encantar as crianças e incentivar o hábito da leitura desde cedo.",
    img: contentImage,
  },
  {
    id: 2,
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="border-b border-gray-800 bg-[#121212] px-6 py-2">
        <div className="mx-auto flex max-w-7xl items-center justify-center gap-8 text-sm font-medium">
          ...
          <Link to="/kids" className="text-red-500 font-bold hover:text-red-500">KIDS</Link>
